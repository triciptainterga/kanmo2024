<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Uidesk_04.aspx.vb" Inherits="ICC.Uidesk_04" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/sweetalert.min.js"></script>
    <script src="js/Uidesk_04.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Application&nbsp;<i class="fa fa-plus" onclick="TransactionModal()" style="cursor: pointer;"></i></h4>
                    </div>
                    <div class="box-body">
                        <table id="DataTables" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow: scroll;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 700PX;">Application</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Application</h5>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Application" id="Application">
                                </div>
                            </div>
                        </div>
                    </div>
