<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrmJumlahFilter.aspx.vb" Inherits="ICC.TrmJumlahFilter" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/sweetalert.min.js"></script>
    <script src="js/TrmJumlahFilter.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Jumlah Filter</h4>
                        <center>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Jumlah Hari</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Jumlah Hari (Filter)</label>
                                <input type="text" class="form-control" id="Jumlah" placeholder="Jumlah Hari">
                            </div>
                        </div>
                    </div>
                </div>
