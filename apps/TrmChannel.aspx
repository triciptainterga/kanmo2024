<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrmChannel.aspx.vb" Inherits="ICC.TrmChannel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/TrmChannel.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="TrxID" runat="server" />
    <%--<button onclick="validateForm()" type="button">Simulasi</button>--%>
    <%-- <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="w-p100 d-md-flex align-items-center justify-content-between">
                <h3 class="page-title">Data Channel <i class="fa fa-plus" onclick="showAdd()"></i></h3>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                            <li class="breadcrumb-item" aria-current="page">Master Data</li>
                            <li class="breadcrumb-item active" aria-current="page">Data Channel</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Channel&nbsp;<i class="fa fa-plus" onclick="showAdd()"></i></h4>
                    </div>
                    <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Channel Transaction</h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Channel Transaction</label>
                                <input type="text" class="form-control" id="TxtChannel" placeholder="Channel Transaction">
                            </div>
                        </div>
                    </div>
                    <div class="row">
