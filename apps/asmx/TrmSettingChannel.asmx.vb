...
<ScriptService()>
<ToolboxItem(False)>
Public Class TrmSettingChannel1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UIDESK_TrxSettingChannelAgent(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxMenu As String,
                                                  ByVal TrxSubMenu As String, ByVal TrxDetailMenu As String, ByVal TrxUrl As String, ByVal TrxStatus As String,
        ...
        Dim TrxSubMenuXSS As String = AntiXssEncoder.HtmlEncode(TrxSubMenu.Trim, True)
        Dim TrxDetailMenuXSS As String = AntiXssEncoder.HtmlEncode(TrxDetailMenu.Trim, True)
        Dim TrxUrlXSS As String = AntiXssEncoder.HtmlEncode(TrxUrl.Trim, True)
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "UIDESK_TrxSettingChannelAgent"
                ...
                sqlComm.Parameters.AddWithValue("TrxSubMenu", TrxSubMenuXSS)
                sqlComm.Parameters.AddWithValue("TrxDetailMenu", TrxDetailMenuXSS)
                sqlComm.Parameters.AddWithValue("TrxUrl", TrxUrlXSS)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxSettingChannelAgent '" & TrxID & "','" & TrxUserNameXSS & "','" & TrxMenu & "','" & TrxSubMenuXSS & "','" & TrxDetailMenuXSS & "','" & TrxUrlXSS & "','" & TrxStatus & "','" & TrxAction & "'"
