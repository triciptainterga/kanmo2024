...
Public Class TrxAgentWA
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertAgentAccountWhatsApp(ByVal TrxID As String, ByVal TrxUserCreate As String, ByVal TrxUserName As String, ByVal TrxUserNameIntegration As String,
                                               ByVal TrxType As String, ByVal TrxProduct As String, ByVal TrxStatus As String, ByVal TrxAction As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim TrxUserCreateXSS As String = AntiXssEncoder.HtmlEncode(TrxUserCreate.Trim, True)
        Dim TrxUserNameXSS As String = AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True)
        Dim TrxUserNameIntegrationXSS As String = AntiXssEncoder.HtmlEncode(TrxUserNameIntegration.Trim, True)
        Dim TrxTypeXSS As String = AntiXssEncoder.HtmlEncode(TrxType.Trim, True)
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "UIDESK_TrxSettingAgentAccountWA"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxUserCreate", TrxUserCreateXSS)
                sqlComm.Parameters.AddWithValue("TrxUserName", TrxUserNameXSS)
                sqlComm.Parameters.AddWithValue("TrxUserNameIntegration", TrxUserNameIntegrationXSS)
                sqlComm.Parameters.AddWithValue("TrxType", TrxTypeXSS)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxSettingAgentAccountWA '" & TrxID & "','" & TrxUserCreateXSS & "','" & TrxUserNameXSS & "','" & TrxUserNameIntegrationXSS & "','" & TrxTypeXSS & "','" & TrxProductXSS & "','" & TrxStatus & "','" & TrxAction & "'"
