...
<ScriptService()>
<ToolboxItem(False)>
Public Class TrsServerProtocol1
    ...
    Public Function UpdateServerProtokol(ByVal TrxID As String, ByVal TrxName As String, ByVal TrxUserName As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "UIDESK_UpdateServerProtokol"
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_UpdateServerProtokol '" & TrxID & "','" & TrxNameXSS & "','" & TrxUserNameXSS & "'"
