...
Public Class Coll_Dashboard
    ...
    Public Class listTransactionThread
        ...
        Public Property TrxTotalPinjaman As String
        Public Property TrxJumlahTagihan As String
        Public Property TrxJatuhTempo As String
    ...
    Public Function TaskboardCounting(ByVal TrxUserName As String) As String
        ...
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sql = "exec Coll_TrxTaskboardCountingCall '" & TrxUserName & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Coll_DashboardSummaryCall(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim sql As String = ""
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sql = "exec Coll_DashboardSummaryCall '" & UserName & "','" & XStartDate & "','" & XEndDate & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Coll_DashboardDurationCall(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim sql As String = ""
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sql = "exec Coll_DashboardDurationCall '" & UserName & "','" & XStartDate & "','" & XEndDate & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Coll_DashboardSummaryData(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim sql As String = ""
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sql = "exec Coll_DashboardSummaryData '" & UserName & "','" & XStartDate & "','" & XEndDate & "'"
