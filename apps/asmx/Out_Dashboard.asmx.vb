...
Public Class Out_Dashboard
    ...
    '<WebMethod(EnableSession:=True)>
    '<ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    'Public Function Out_DashboardSummaryCall(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String) As String
    '    Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
    '    Dim dt As DataTable = New DataTable()
    '    Dim sql As String = ""
    '    Try
    ...
    '            sql = "exec Out_DashboardSummaryCall '" & UserName & "','" & XStartDate & "','" & XEndDate & "'"
    ...
    '<WebMethod(EnableSession:=True)>
    '<ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    'Public Function Out_DashboardDurationCall(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String) As String
    '    Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
    '    Dim dt As DataTable = New DataTable()
    '    Dim sql As String = ""
    '    Try
    ...
    '            sql = "exec Out_DashboardDurationCall '" & UserName & "','" & XStartDate & "','" & XEndDate & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Out_DashboardSummaryData(ByVal UserName As String, ByVal XStartDate As String, ByVal XEndDate As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim sql As String = ""
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sql = "exec Out_DashboardSummaryData '" & UserName & "','" & XStartDate & "','" & XEndDate & "'"
