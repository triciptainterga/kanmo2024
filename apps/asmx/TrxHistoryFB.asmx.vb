...
Public Class TrxHistoryFB1
    ...
    Public Function UIDESK_TrxHistoryFB(ByVal TrxStartDate As String, ByVal TrxEndDate As String, ByVal TrxUserName As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim NameSP As String = "Exec UIDESK_TrxHistoryFB"
        Dim sql As String = "" & NameSP & " '" & TrxStartDate & "', '" & TrxEndDate & "', '" & TrxUserName & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("UIDESK_TrxHistoryFB", conn)
