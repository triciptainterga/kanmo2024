...
<ScriptService()>
<ToolboxItem(False)>
Public Class TrsEmailServiceMethod1
    ...
    Public Function UpdateServiceMethod(ByVal TrxID As String, ByVal TrxName As String, ByVal TrxUserName As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "UIDESK_UpdateServiceMethod"
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_UpdateServiceMethod '" & TrxID & "','" & TrxNameXSS & "','" & TrxUserNameXSS & "'"
