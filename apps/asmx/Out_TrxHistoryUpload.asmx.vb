...
<ScriptService()>
<ToolboxItem(False)>
Public Class Out_TrxHistoryUpload1
    ...
    Public Function DeleteDataUpload(ByVal Action As String, ByVal UploadID As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "Out_HistoryDataUpload"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("@Action", Action)
                sqlComm.Parameters.AddWithValue("@UploadID", UploadID)
                con.Open()
        ...
        Catch ex As Exception
            ...
            strExec = "exec Out_HistoryDataUpload '" & Action & "','" & UploadID & "'"
