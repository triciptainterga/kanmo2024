...
<ScriptService()>
<ToolboxItem(False)>
Public Class ServiceChannelInbox
    ...
    Public Function InsertDataChannelToThread(ByVal ConversationID As String, ByVal ThreadID As String, ByVal NumberID As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "UIDESK_Temp_InsertChannelToThread"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxConversationID", ConversationID)
                sqlComm.Parameters.AddWithValue("TrxThreadID", ThreadID)
                sqlComm.Parameters.AddWithValue("TrxNumberID", NumberID)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_Temp_InsertChannelToThread " & "'" & ConversationID & "'," & "'" & ThreadID & "'"
