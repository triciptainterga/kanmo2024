...
Public Class TrmSignature1
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateSignature(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxSignature As String) As String
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxSignature '" & TrxID & "','" & TrxUserName & "','" & TrxSignature & "'"
