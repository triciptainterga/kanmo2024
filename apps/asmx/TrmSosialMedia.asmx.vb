...
Public Class TrmSosialMedia1
    ...
    Public Function UpdateAcccountSosialMedia(ByVal TrxID As String, ByVal TrxAccountName As String, ByVal TrxAccountType As String,
                                              ByVal TrxAccountStatus As String, ByVal TrxUserName As String, ByVal TrxAction As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim TrxAccountNameXSS As String = AntiXssEncoder.HtmlEncode(TrxAccountName.Trim, True)
        Dim TrxAccountTypeXSS As String = AntiXssEncoder.HtmlEncode(TrxAccountType.Trim, True)
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "UIDESK_TrxAccountSosialMedia"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxAccountName", TrxAccountNameXSS)
                sqlComm.Parameters.AddWithValue("TrxAccountType", TrxAccountTypeXSS)
                sqlComm.Parameters.AddWithValue("TrxAccountStatus", TrxAccountStatus)
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxAccountSosialMedia '" & TrxID & "','" & TrxAccountNameXSS & "','" & TrxAccountTypeXSS & "','" & TrxAccountStatus & "','" & TrxUsernameXSS & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.TrxmsgSystem = "Data Has Been Success"
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxAccountSosialMedia '" & TrxID & "','" & TrxAccountNameXSS & "','" & TrxAccountTypeXSS & "','" & TrxAccountStatus & "','" & TrxUsernameXSS & "','" & TrxAction & "'"
