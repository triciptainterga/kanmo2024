...
Public Class Tele_TrxUpload1
    ...
    Public Function TeleUpload_1() As Response
        ...
        '    Dim json As String = "{""asal"":""FileTelemarketing/" & strTime & "/" & String.Concat(FileId, FileExt) & """,""tujuan"":""FileTelemarketing/" & strTime & "/" & String.Concat(FileId, FileExt) & """, ""app"":""UIDESK_V2""}"
