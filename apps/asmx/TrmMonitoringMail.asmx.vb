...
<ScriptService()>
<ToolboxItem(False)>
Public Class TrmMonitoringMail1
    ...
    Public Function DataTableTaskboard(ByVal ID As String, ByVal UserName As String, ByVal Account As String, ByVal StartDate As String,
                                       ByVal EndDate As String, ByVal Action As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
        Dim NameSP As String = "Exec KAN_EmailMonitoring"
        Dim sql As String = "" & NameSP & " '" & ID & "', '" & UserName & "', '" & Account & "','" & StartDate & "','" & EndDate & "','" & Action & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("KAN_EmailMonitoring", conn)
