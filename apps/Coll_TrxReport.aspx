<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Coll_TrxReport.aspx.vb" Inherits="ICC.Coll_TrxReport" %>
                    ...
                    <div class="box-body">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%" Styles-Header-HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Name" FieldName="Name" Width="150px"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Gender" FieldName="Gender" Width="150px"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Birth Date" FieldName="BirthDate" Width="150px"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Email" FieldName="Email" Width="150px"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Telepon" FieldName="Telepon" Width="150px"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Job Tittle" FieldName="JobTitle" Width="150px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Pinjaman" FieldName="TotalPinjaman" Width="150px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="JumlahTagihan" FieldName="JumlahTagihan" Width="150px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Periode From" FieldName="PeriodeFrom" Width="150px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Periode To" FieldName="PeriodeTo" Width="150px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Status Call" FieldName="CallReason" Width="150px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Keterangan" FieldName="Keterangan" Width="300px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>
