<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="4_Report_Mention.aspx.vb" Inherits="ICC._4_Report_Mention" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-full">
            ...
            <div class="d-flex align-items-center">
                <div class="w-p100 d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Report Sosial Media Mention</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <section class="content">
                    ...
                    <div class="box">
                        <div class="box-body p-15">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                DataSourceID="TempBaseMention" Width="100%" Styles-Header-Font-Bold="true" Theme="MetropolisBlue">
                                <SettingsPager>
                                    <AllButton Text="All">
                                    </AllButton>
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Header Sosmed" FieldName="HeaderSosmed" Width="300px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Account" FieldName="ProfileAccount" Width="300px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Mention Message" FieldName="MessageMention" Width="400px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Mention Type" FieldName="MentionType" Width="300px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Date Mention" FieldName="DateMention" Width="300px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd hh:mm:ss"></dx:GridViewDataDateColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                    </div>
            ...
            <asp:SqlDataSource ID="TempBaseMention" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" runat="server"></asp:SqlDataSource>
        </section>
    </div>
</asp:Content>
