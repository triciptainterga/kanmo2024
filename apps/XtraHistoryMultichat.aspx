<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="XtraHistoryMultichat.aspx.vb" Inherits="ICC.XtraHistoryMultichat" %>
            ...
            <div class="d-flex align-items-center">
                <div class="w-p100 d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Report Whatsapp Channel</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="box">
                        <div class="box-body p-15">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" 
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="SessionID" FieldName="chat_header_id" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Source Chat" FieldName="code" Width="200px"></dx:GridViewDataTextColumn>
									...
									<dx:GridViewDataTextColumn Caption="Agentname" FieldName="Agentname" Width="200px"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="created_at" Settings-AllowHeaderFilter="true"  FieldName="created_at" Width="200px"></dx:GridViewDataTextColumn>
