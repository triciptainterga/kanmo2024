<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrxHistoryOutboundCall.aspx.vb" Inherits="ICC.TrxHistoryOutboundCall" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content">
                                    ...
                                    <div id="navpills-2" class="tab-pane">
                                        ...
                                        <div class="box-footer">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <a class="btn btn-rounded btn-success btn-outline pull-right" onclick="post_WS_OutboundReminder()" style="display:none;">
                                                            <i class="fa fa-save"></i>&nbsp;Submit
                                                        </a>
                                                    </div>
                                                </div>
        ...
        <div id="chat-box-body" style="visibility:hidden;">
