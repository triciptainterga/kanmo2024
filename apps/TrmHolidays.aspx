<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrmHolidays.aspx.vb" Inherits="ICC.TrmHolidays1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/sweetalert.min.js"></script>
       <script src="js/TrmHolidays.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Holidays&nbsp;<i class="fa fa-plus" onclick="showAdd()"></i></h4>
                        <center>
                            <div class="spin2" id="LoaderPage"></div>
                        </center>
                    </div>
                    <div class="box-body">
                        <table id="TrmHolidays" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow: scroll;">
                            <thead>
                                <tr>
                                    <th>ID</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 900px; margin-left: -200px;">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Holidays</h5>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="Holiday_Start" placeholder="Holiday Start Date">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>End Date</label>
                                <input type="date" class="form-control" id="Holiday_End" placeholder="Holiday End Date">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
