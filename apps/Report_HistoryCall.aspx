<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Report_HistoryCall.aspx.vb" Inherits="ICC.Report_HistoryCall" %>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Call Report</h4>
                    </div>
                    <div class="box-body">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%" Styles-Header-HorizontalAlign="Center"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="ID" FieldName="ID" Width="40px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="CALL TYPE" FieldName="CALLTYPE" Width="200px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>
                        <hr />
                        <div class="row">
