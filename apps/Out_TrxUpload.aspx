<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Out_TrxUpload.aspx.vb" Inherits="ICC.Out_TrxUpload" %>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Upload Outbound Call</h4>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Outbound Campaign Name <span class="text-danger">*</span></label>
                                    <select id="ComboCampaign" class="form-control" style="height: 33px;" onchange="OnchangeComboUpload()">
                            ...
                            <div class="col-md-3" style="margin-top: 8px;">
                                ...
                                <a href="../FileTemplateUpload/Outbound.xlsx" class="text-primary"><i class="mdi mdi-cloud-download float-right"></i></a>
