function getData() {
    ...
    var jsonText = JSON.stringify({ BulanNya: "7",TahunNya: "2022",JenisReport: "Performance",TypeReport: "Non Call",SkillAgent: "BRIlink dan Merchant Non Call",UserName: "90135204" });
    $.ajax({
        type: "POST",
