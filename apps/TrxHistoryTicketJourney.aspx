                            ...
                            <div class="box">
                                <div class="box-body bg-white">
                                                            ...
                                                            <div class="fx-card-avatar fx-overlay-1">
                                                                <img src="../images/card/2.jpg" alt="user"><div class="fx-overlay">
                                                                    <ul class="fx-info">
                                                                        ...
                                                                        <li><a class="btn default btn-outline" href="1_Journey.aspx?ticketid=<%=Request.QueryString("ticketid")%>"><i class="fa fa-refresh"></i></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row" style="margin-top: -20px;">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="select" id="Journey_EscalationChannel" onchange="getWS_EscalationChannel(1);" required class="form-control" style="height: 33px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <div class="btn btn-rounded btn-default btn-file" id="btnAttachment" style="visibility:hidden">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>&nbsp;</label>
                                                <a class="btn btn-rounded btn-success btn-outline pull-right" onclick="post_WS_DataInteraction()" id="btnInteraction" style="visibility:hidden">
                            ...
                            <div class="box p-15">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <a class="btn btn-rounded btn-success btn-outline pull-right" onclick="post_WS_TicketReminder()" style="visibility:hidden">
                                                <i class="fa fa-save"></i>&nbsp;Submit
                                            </a>
                                        </div>
                                    </div>
    ...
    <div class="modal modal-right fade" id="modal-individual" tabindex="-1" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer modal-footer-uniform">
                    <a href="#" class="btn btn-rounded btn-success btn-outline pull-left" onclick="submitIndividual()" id="BTN_SubmitIndividual" style="visibility:hidden">
