<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Coll_TrxReportSummaryCall.aspx.vb" Inherits="ICC.Coll_TrxReportSummaryCall" %>
                    ...
                    <div class="box-body">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%" Styles-Header-HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Data Not Calls" FieldName="DataNotCall" Width="150px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Data Complete Calls" FieldName="CompleteCall" Width="150px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Data Not Complete Calls" FieldName="AnotherCall" Width="150px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                            </Columns>
                            <TotalSummary>
