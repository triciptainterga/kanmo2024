<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrsServerProfile.aspx.vb" Inherits="ICC.TrsServerProfile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/TrsServerProfile.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Email Server Profile</h4>
                        <center>
                            <div class="spin2" id="LoaderPage"></div>
                        </center>
                    </div>
                    <div class="box-body">
                        <table id="TrsServerProfile" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow: scroll;">
                            <thead>
                                <tr>
                                    <th>ID</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="width: 900px; margin-left: -190px;">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Server Profile</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>IP Server Name</label>
                                <input type="text" class="form-control" id="IP_Server_Name" placeholder="IP Server Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Database_Password" placeholder="Database Password">
                            </div>
                        </div>
                    </div>
                </div>
