<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrxHistoryIG.aspx.vb" Inherits="ICC.TrxHistoryIG" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/sweetalert.min.js"></script>
    <script src="js/TrxHistoryIG.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">History Data Instagram</h4>
                            ...
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="TrxHistory" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow-y: scroll;">
                                        <thead>
                                            <tr>
                                                <th style="width: 150px;">Header ID</th>
                                                <th style="width: 150px;">Account</th>
                                                <th style="width: 400px; overflow-y:scroll;">Message</th>
                                                <th style="width: 150px;">Date Post</th>
                                                <th style="width: 150px;">Account Comment</th>
                                                <th style="width: 400px;">Message Comment</th>
                                                <th style="width: 150px;">Date Comment</th>
                                                <th style="width: 150px;">Account Reply</th>
                                                <th style="width: 400px;">Message Reply</th>
                                                <th style="width: 150px;">Date Reply</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Setting History Instagram</h5>
