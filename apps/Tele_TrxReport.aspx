<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Tele_TrxReport.aspx.vb" Inherits="ICC.Tele_TrxReport" %>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Report Transaksi Telekonfirmasi</h4>
                    </div>
                    <div class="box-body">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView" runat="server" Width="100%" Styles-Header-HorizontalAlign="Center"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataTextColumn Caption="Tanggal & Jam Dial" FieldName="DateCall" Width="200px"></dx:GridViewDataTextColumn>
