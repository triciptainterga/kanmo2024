<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrmCategory.aspx.vb" Inherits="ICC.TrmCategory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/TrmCategory.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%-- <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="w-p100 d-md-flex align-items-center justify-content-between">
                <h3 class="page-title">Data Category <i class="fa fa-plus" onclick=showAdd()></i></h3>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Type &nbsp;<i class="fa fa-plus" onclick="showAdd()" style="cursor:pointer;"></i></h4>
                        <center>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Type</h5>
                ...
                <div class="modal-body">
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Brand</label>
                                <select name="select" id="cmbBrand" class="form-control" style="height: 33px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Type</label>
                                <input type="text" class="form-control" id="TxtCategoryName" placeholder="Type">
                            </div>
                        </div>
                    </div>
                    <%--<div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="NameEditor" name="NameEditor" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>--%>
                    <div class="row">
    ...
    <%--  <script>
        var NameEditor = CKEDITOR.replace('NameEditor');
        NameEditor.config.height = 150;
        NameEditor.config.toolbar = 'Basic';
        NameEditor.config.toolbar_Basic =
            [
