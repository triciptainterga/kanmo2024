<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Coll_TrxHistory.aspx.vb" Inherits="ICC.Coll_TrxHistory" %>
                                ...
                                <dx:GridViewDataHyperLinkColumn VisibleIndex="1" Settings-FilterMode="DisplayText" Caption="ID" CellStyle-HorizontalAlign="Center"
                                    ...
                                    <DataItemTemplate>
                                        <dx:ASPxHyperLink ForeColor="#333333" Font-Underline="true" Font-Size="10px" ID="ASPxHyperLinkTest" Target="_blank" runat="server" Text='<%#Eval("ID") %>'
                                            NavigateUrl='<%#String.Format("Coll_TrxTransaksi.aspx?id={0}&name={1}&ph={2}&email={3}&script={4}", Eval("ID"), Eval("Name"), Eval("Telepon"), Eval("Email"), Eval("ProdukID"))%>'>
                                        </dx:ASPxHyperLink>
                                    </DataItemTemplate>
