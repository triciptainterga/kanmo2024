<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="TrmBrand.aspx.vb" Inherits="ICC.TrmBrand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/TrmBrand.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Brand&nbsp;<i class="fa fa-plus" onclick="showAdd()" style="cursor:pointer;"></i></h4>
                    </div>
                    <div class="box-body">
                        <table id="TrmBrandNames" class="table mt-0 table-hover no-wrap table-borderless" style="width: 100%; overflow-x: scroll; overflow: scroll;">
                            <thead>
                                <tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Data Brand Name</h5>
