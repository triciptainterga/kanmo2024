<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="XtraAssignEmail.aspx.vb" Inherits="ICC.XtraAssignEmail" %>
            ...
            <div class="col-xl-12 col-lg-12 col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Report Assign Email&nbsp;</h4>
                    </div>
                    <div class="box-body p-15">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="DSChannel" runat="server" Width="100%"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="ID" FieldName="ID" Width="50px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="Subject" FieldName="ESubject" Width="500px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataTextColumn Caption="Agent From" FieldName="AssignFrom" Width="250px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Agent To" FieldName="AssignTo" Width="250px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Assign Reason" FieldName="AssignReason" Width="250px" Settings-AutoFilterCondition="Contains"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="User Assign" FieldName="AssignUser" Width="250px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Assign Type" FieldName="AssignType" Width="250px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Date Assign" FieldName="DateCreate" Width="250px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:ASPxGridView>
