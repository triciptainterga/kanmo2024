<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Tele_TrxUpload.aspx.vb" Inherits="ICC.Tele_TrxUpload" %>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Data Upload Teleconfirm</h4>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select id="ComboCampaignTelemarketing" class="form-control" style="height: 33px;">
