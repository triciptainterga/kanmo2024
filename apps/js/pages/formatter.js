...
$(function () {
  'use strict';
    ...
    $('#CIF_Ticket').formatter({
        'pattern': '{{9999999999999}}',
        'persistent': true
    });
    $('#NIK_Ticket').formatter({
        'pattern': '{{999999999999999999999999}}',
        'persistent': true
    });

	//Phone 2 E.g. +1 123-456-7890
	$('#phone2').formatter({
	  'pattern': '+{{99999}}-{{9999}}-{{99999}}',
	  'persistent': true
	});
    //Email Customer
    $('#EmailCustomer_Ticket').formatter({
        'pattern': '({{aaaaaaaaaaaaa}})@{{aaaaaaa}}.{{aaaaaaaa}}',
        'persistent': true
    });
	//Percent E.g. %25.36
	$('#percent').formatter({
