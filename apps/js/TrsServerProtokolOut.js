$(document).ready(function () {
    TrsServerProtocolOut();
    $("#LoaderPage").hide();
});
function TrsServerProtocolOut() {
    var myTable = $('#TrsServerProtocolOut').DataTable();
    $.ajax({
        type: "POST",
        url: "WebServiceGetDataMaster.asmx/UIDESK_TrmMasterCombo",
        data: "{TrxID:'4', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK49'}",
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "asmx/TrsServerProtokolOut.asmx/UpdateServerProtokolOut",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
