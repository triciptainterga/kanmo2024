...
function ActionSendDataToThread(id, Valthreadid, Valthreadnumber) {  
    var form_data = JSON.stringify({ ConversationID: id, ThreadID: Valthreadid, NumberID: Valthreadnumber});
    if (confirm("Do you want to process?")) {
        $.ajax({
            url: "asmx/ServiceChannelInbox.asmx/InsertDataChannelToThread",
            method: "POST",
            ...
            data: form_data,
            success: function () {
                console.log("Function ActionSendToThread : " + form_data)
                var TrxMessage = 'Your data channel</b> has been send to thread'
