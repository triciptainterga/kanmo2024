$(document).ready(function () {
    ...
    TrmAgentCollection("16")
    CmbProductCampaign();
    CmbMaximalHandle();
    DataTableAgent();
});
function TrmAgentCollection(campaign_id) {
    $.ajax({
        type: "POST",
        url: "WebServiceGetDataMaster.asmx/UIDESK_TrmMasterCombo",
        data: "{TrxID:'" + campaign_id + "', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK86'}",
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                resultUserNotification = '<div class="col-md-12 col-lg-2 fx-element-overlay">' +
...
function DataTableAgent() {
    ...
    $.ajax({
        type: "POST",
        url: "WebServiceGetDataMaster.asmx/UIDESK_TrmMasterCombo",
        data: "{TrxID:'8', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK14'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "asmx/Coll_TrxAgent.asmx/ReleaseNowhandle",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
                        ...
                        for (i = 0; i < json.length; i++) {
                            if (json[i].Result == "True") {
                                swal(
                                    ...
                                    window.location = "Coll_TrxAgent.aspx";
                                });
                            } else {
                                swal(
                                    '',
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "asmx/Coll_TrxAgent.asmx/UpdateAgentDistributionData",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
                        ...
                        for (i = 0; i < json.length; i++) {
                            if (json[i].Result == "True") {
                                swal(
                                    ...
                                    window.location.href = "Coll_TrxAgent.aspx";
                                });
                            } else {
                                swal(
                                    '',
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                var form_data = JSON.stringify({ TrxID: $("#ContentPlaceHolder1_TrxID").val(), TrxUserName: $("#hd_sessionLogin").val() });
                $.ajax({
                    url: "asmx/Coll_TrxAgent.asmx/DeleteAgentProductCampaign",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
...
function AgentCheck(TrxAgentID) {
    $.ajax({
        type: "POST",
        url: "WebServiceGetDataMaster.asmx/UIDESK_TrmMasterCombo",
        data: "{TrxID:'" + TrxAgentID + "', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK102'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        url: "asmx/Coll_TrxAgent.asmx/InsertAgentProductCampaign",
                        method: "POST",
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: form_data,
