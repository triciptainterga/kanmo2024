$(document).ready(function () {
    ...
    TrmAgentTelemarketing("14")
    CmbProductCampaign();
    CmbMaximalHandle();
    DataTableAgent();
});
function TrmAgentTelemarketing(campaign_id) {
    $.ajax({
        type: "POST",
        url: "WebServiceGetDataMaster.asmx/UIDESK_TrmMasterCombo",
        data: "{TrxID:'" + campaign_id + "', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK85'}",
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                resultUserNotification = '<div class="col-md-12 col-lg-4 fx-element-overlay">' +
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "asmx/Tele_TrxAgent.asmx/ReleaseNowhandle",
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: form_data,
                        ...
                        for (i = 0; i < json.length; i++) {
                            if (json[i].Result == "True") {
                                swal(
                                    ...
                                    window.location = "Tele_TrxAgent.aspx";
                                });
                            } else {
                                swal(
                                    '',
