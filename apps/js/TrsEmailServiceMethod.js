$(document).ready(function () {
    TrsEmailServiceMethod();
    $("#LoaderPage").hide();
});
function TrsEmailServiceMethod() {
    var myTable = $('#TrsEmailServiceMethod').DataTable();
    $.ajax({
        type: "POST",
        url: "WebServiceGetDataMaster.asmx/UIDESK_TrmMasterCombo",
        data: "{TrxID:'2', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'UIDESK49'}",
