...
$(document).ready(function() {
    ...
    console.log(getParameterByName("callto"));
    ...
    ctxSip = {
        ...
        phoneCallButtonPressed : function(sessionid) {
            ...
            var s      = ctxSip.Sessions[sessionid],
                ...
                target = getParameterByName("callto");
    ...
    ctxSip.phone.on('registered', function(e) {
        ...
        if (getParameterByName("callto") != "") {
            ctxSip.phoneCallButtonPressed();
        }

        // Get the userMedia and cache the stream
        if (SIP.WebRTC.isSupported()) {
            SIP.WebRTC.getUserMedia({ audio : true, video : true }, ctxSip.getUserMediaSuccess, ctxSip.getUserMediaFailure);
        }
    });
