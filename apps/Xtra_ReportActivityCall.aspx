<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/apps/Uidesk.Master" CodeBehind="Xtra_ReportActivityCall.aspx.vb" Inherits="ICC.Xtra_ReportActivityCall" %>
            ...
            <div class="d-flex align-items-center">
                <div class="w-p100 d-md-flex align-items-center justify-content-between">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active" aria-current="page">Report Summary Call</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="box">
                        <div class="box-body p-15">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="AgentName" FieldName="AgentName" Width="350px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="TotalCall" FieldName="TotalCall" Width="350px"></dx:GridViewDataTextColumn>
                                    <%--<dx:GridViewDataTextColumn Caption="Avg Duration" FieldName="ConvertSecond" Width="250px"></dx:GridViewDataTextColumn>--%>
                                    <dx:GridViewDataTextColumn Caption="Call Type" FieldName="CallType" Width="350px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Start Date" FieldName="StartDate" Width="350px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="End Date" FieldName="EndDate" Width="350px"></dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                    </div>
